...
public class RobotArmController : MonoBehaviour
{
    ...
    public GameObject targetObject;        // 잡을 물체: Target
    public GameObject targetPlacement;     // 놓을 위치: TargetPlacement
    ...
    private void OnGraspCommand(GraspCommandMsg msg)
    {
        ...
        Debug.Log($"✅ 명령 수신: object_type={msg.object_type}, force={msg.force}, is_fragile={msg.is_fragile}");
    ...
    private IEnumerator PickAndPlace(GameObject target, GraspCommandMsg msg)
    {
        ...
        PublishFeedback(true, msg.force, "success");
